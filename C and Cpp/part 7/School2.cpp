		...
		while(true)
		{
			...
			while(true)
			{
				...
				if(x1)
				{
					...
					std::cout << "You have already entered the roll numbers for cricket.\nEnter again?? : - ";
				...
				if(x2)
				{
					...
					std::cout << "You have already entered the roll numbers for football.\nEnter again?? : - ";
				...
				if(x3)
				{
					...
					std::cout << "You have already entered the roll numbers for other.\nEnter again?? : - ";
