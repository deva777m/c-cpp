...
public:
	...
	void assignment(int m_x) // In this example we have a ambiguity that the member fuction and the member fuction argument is same. 
	{		         // Since this is member fuction compiler implicitly adds one more argument ie the *this pointer :- 
				 // this pointer has the address of the current object being worked upon.
